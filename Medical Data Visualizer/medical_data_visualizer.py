...
#Adding an Overweight column to the dataframe and normalizing the data
...
#Normalizing glucose data using lambda and .apply()
df["gluc"] = df["gluc"].apply(lambda x: 0 if x==1 else 1);

#Normalizing cholesterol data using .apply() and lambda
